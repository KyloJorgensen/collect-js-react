...
declare type VGSCollectVaultEnvironment = 'sandbox' | 'live' | 'live-eu-1';
/**
 * Available options for .field() method configuration
 */
declare type BooleanValue = boolean | 'true' | 'false';
declare type YearLength = '2' | '4' | 2 | 4;
/**
 * Available options for .submit() method
 */
declare type SubmitMethod = 'post' | 'patch' | 'put' | 'delete' | 'get';
declare type SubmitSerializer = 'deep' | 'flat';
declare type SubmitSerialization = 'json' | 'formData';
declare type SubmitMapDotToObject = BooleanValue | 'merge' | 'mergeArray';
declare type InputMode = 'none' | 'text' | 'decimal' | 'numeric' | 'tel' | 'search' | 'email' | 'url';
declare type StorageTypes = 'PERSISTENT' | 'VOLATILE';
declare type TokenFormats = 'FPE_ACC_NUM_T_FOUR' | 'FPE_ALPHANUMERIC_ACC_NUM_T_FOUR' | 'FPE_SIX_T_FOUR' | 'FPE_SSN_T_FOUR' | 'FPE_T_FOUR' | 'RAW_UUID' | 'UUID' | 'NUM_LENGTH_PRESERVING' | 'PFPT';
/**
 * Available options for the form .on() method
 */
declare type FormEventTypes = 'enterPress';
...
declare type VGSCollectFormState = Record<string, VGSCollectStateParams> | null;
...
declare type FieldConfig = IVGSCollectTextField | IVGSCollectCardNumberField | IVGSCollectCardExpirationField | IVGSCollectCardCVCField | IVGSCollectSSNField | IVGSCollectZipCodeField | IVGSCollectPasswordField | IVGSCollectNumberField | IVGSCollectTextareaField;
...
interface IVGSCollectForm {
     ...
     */
    on(event: FormEventTypes, callback: (info: {
        name: string;
    }) => void): void;
     ...
     */
    submit(path: string, options: Partial<VGSCollectSubmitOptions>, successCallback?: (status: VGSCollectHttpStatusCode | null, data: any) => any, errorCallback?: (error: VGSCollectFormState) => any): any;
    /**
     * Docs: https://www.verygoodsecurity.com/docs/api/collect/#api-formtokenize
     */
    tokenize(successCallback: (status: VGSCollectHttpStatusCode | null, data: any) => any, errorCallback: (error: VGSCollectFormState) => any): any;
    /**
...
declare type ICollectFieldAlias = {
    __type: string;
    elementIndex: any;
    key: string;
};
...
export type { IVGSCollect, IVGSCollectForm, IVGSCollectTextField, IVGSCollectCardNumberField, IVGSCollectCardExpirationField, IVGSCollectCardCVCField, IVGSCollectSSNField, IVGSCollectZipCodeField, IVGSCollectPasswordField, IVGSCollectNumberField, IVGSCollectTextareaField, IVGSCollectDateField, IVGSCollectFileField, ICollectFormProps, ICollectFormPayloadStructure, VGSCollectFormState, VGSCollectStateParams, VGSCollectVaultEnvironment, VGSCollectHttpStatusCode };
