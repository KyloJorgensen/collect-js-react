...
var GlobalSubmitContext = /*#__PURE__*/React.createContext(initialState);
var DispatchSubmitContext = /*#__PURE__*/React.createContext({});
var GlobalStateContext = /*#__PURE__*/React.createContext(initialState);
var DispatchStateContext = /*#__PURE__*/React.createContext({});
var GlobalStateProvider = function GlobalStateProvider(_ref) {
  var children = _ref.children;
  var _useReducer = React.useReducer(function (_state, newValue) {
      return newValue ? _extends({}, newValue) : initialState;
    }, initialState),
    state = _useReducer[0],
    dispatch = _useReducer[1];
  var _useReducer2 = React.useReducer(function (_state, newValue) {
      return newValue ? _extends({}, newValue) : initialState;
    }, initialState),
    response = _useReducer2[0],
    dispatchSubmit = _useReducer2[1];
  var memoState = React.useMemo(function () {
    return state;
  }, [state]);
  var memoResponse = React.useMemo(function () {
    return response;
  }, [response]);
  return /*#__PURE__*/React__default.createElement("div", null, /*#__PURE__*/React__default.createElement(GlobalStateContext.Provider, {
    value: memoState
  }, /*#__PURE__*/React__default.createElement(DispatchStateContext.Provider, {
    value: dispatch
  }, /*#__PURE__*/React__default.createElement(GlobalSubmitContext.Provider, {
    value: memoResponse
  }, /*#__PURE__*/React__default.createElement(DispatchSubmitContext.Provider, {
...
var useVGSCollectResponse = function useVGSCollectResponse() {
  return [React.useContext(GlobalSubmitContext)];
};
var VGSCollectProvider = function VGSCollectProvider(_ref2) {
  var children = _ref2.children;
  return /*#__PURE__*/React__default.createElement(GlobalStateProvider, null, children);
};
...
var TextField = /*#__PURE__*/React__default.memo(function (props) {
  return /*#__PURE__*/React__default.createElement(RenderField, Object.assign({}, Object.assign(_extends({}, DEFAULT_CONFIG.TEXT), props)));
});
var CardNumberField = /*#__PURE__*/React__default.memo(function (props) {
  return /*#__PURE__*/React__default.createElement(RenderField, Object.assign({}, Object.assign(_extends({}, DEFAULT_CONFIG.CARD_NUMBER), props)));
});
var CardExpirationDateField = /*#__PURE__*/React__default.memo(function (props) {
  return /*#__PURE__*/React__default.createElement(RenderField, Object.assign({}, Object.assign(_extends({}, DEFAULT_CONFIG.CARD_EXPIRATION_DATE), props)));
});
var CardSecurityCodeField = /*#__PURE__*/React__default.memo(function (props) {
  return /*#__PURE__*/React__default.createElement(RenderField, Object.assign({}, Object.assign(_extends({}, DEFAULT_CONFIG.CARD_SECURITY_CODE), props)));
});
var PasswordField = /*#__PURE__*/React__default.memo(function (props) {
  return /*#__PURE__*/React__default.createElement(RenderField, Object.assign({}, Object.assign(_extends({}, DEFAULT_CONFIG.PASSWORD), props)));
});
var SSNField = /*#__PURE__*/React__default.memo(function (props) {
  return /*#__PURE__*/React__default.createElement(RenderField, Object.assign({}, Object.assign(_extends({}, DEFAULT_CONFIG.SSN), props)));
});
var ZipCodeField = /*#__PURE__*/React__default.memo(function (props) {
  return /*#__PURE__*/React__default.createElement(RenderField, Object.assign({}, Object.assign(_extends({}, DEFAULT_CONFIG.ZIP_CODE), props)));
});
var TextareaField = /*#__PURE__*/React__default.memo(function (props) {
  return /*#__PURE__*/React__default.createElement(RenderField, Object.assign({}, Object.assign(_extends({}, DEFAULT_CONFIG.TEXTAREA), props)));
});
var NumberField = /*#__PURE__*/React__default.memo(function (props) {
  return /*#__PURE__*/React__default.createElement(RenderField, Object.assign({}, Object.assign(_extends({}, DEFAULT_CONFIG.NUMBER), props)));
});
var DateField = /*#__PURE__*/React__default.memo(function (props) {
  return /*#__PURE__*/React__default.createElement(RenderField, Object.assign({}, Object.assign(_extends({}, DEFAULT_CONFIG.DATE), props)));
});
var FileField = /*#__PURE__*/React__default.memo(function (props) {
  return /*#__PURE__*/React__default.createElement(RenderField, Object.assign({}, Object.assign(_extends({}, DEFAULT_CONFIG.FILE), props)));
});
...
function VGSCollectForm(props) {
  ...
  var dispatchFormStateUpdate = React.useContext(DispatchStateContext);
  var dispatchResponseUpdate = React.useContext(DispatchSubmitContext);
...
exports.DispatchStateContext = DispatchStateContext;
exports.DispatchSubmitContext = DispatchSubmitContext;
exports.GlobalStateContext = GlobalStateContext;
exports.GlobalStateProvider = GlobalStateProvider;
exports.GlobalSubmitContext = GlobalSubmitContext;
exports.VGSCollectForm = VGSCollectForm;
exports.VGSCollectProvider = VGSCollectProvider;
exports.initialState = initialState;
exports.useVGSCollectResponse = useVGSCollectResponse;
exports.useVGSCollectState = useVGSCollectState;
